...
export const allTools = [
    ...
    { id: 17, slug: 'meme-generator', name: 'Meme Generator', category: 'image', desc: 'Create custom memes with text on popular templates.', isPremium: false, componentKey: 'Placeholder' },
    { id: 18, slug: 'favicon-generator', name: 'Favicon Generator', category: 'image', desc: 'Generate ICO and PNG favicons for websites.', isPremium: false, componentKey: 'Placeholder' },
    { id: 19, slug: 'svg-optimizer', name: 'SVG Optimizer', category: 'image', desc: 'Clean and minify SVG files to reduce footprint.', isPremium: false, componentKey: 'Placeholder' },
    { id: 20, slug: 'color-picker', name: 'Color Picker', category: 'image', desc: 'Extract specific colors (HEX/RGB) from an image.', isPremium: false, componentKey: 'Placeholder' },
    ...
    { id: 32, slug: 'loan-calculator', name: 'Loan Calculator', category: 'finance', desc: 'Estimate total interest and repayment schedules.', isPremium: false, componentKey: 'Placeholder' },
    { id: 33, slug: 'gst-calculator', name: 'GST Calculator', category: 'finance', desc: 'Calculate exact Goods and Services Tax inclusive/exclusive.', isPremium: false, componentKey: 'Placeholder' },
    { id: 34, slug: 'currency-converter', name: 'Currency Converter', category: 'finance', desc: 'Convert between 150+ global currencies with live rates.', isPremium: false, componentKey: 'Placeholder' },
    { id: 35, slug: 'sip-calculator', name: 'SIP Calculator', category: 'finance', desc: 'Calculate compounding returns for mutual funds.', isPremium: false, componentKey: 'Placeholder' },
    { id: 36, slug: 'profit-margin', name: 'Profit Margin Calculator', category: 'finance', desc: 'Find gross and net profit margins instantly.', isPremium: false, componentKey: 'Placeholder' },
    { id: 37, slug: 'salary-calculator', name: 'Salary Calculator', category: 'finance', desc: 'Convert hourly wage to annual salary and vice-versa.', isPremium: false, componentKey: 'Placeholder' },
    { id: 38, slug: 'simple-interest', name: 'Simple Interest Calculator', category: 'finance', desc: 'Calculate interest accrued on principal amounts.', isPremium: false, componentKey: 'Placeholder' },
    { id: 39, slug: 'cagr-calculator', name: 'CAGR Calculator', category: 'finance', desc: 'Calculate Compound Annual Growth Rate for investments.', isPremium: false, componentKey: 'Placeholder' },
    { id: 40, slug: 'roi-calculator', name: 'ROI Calculator', category: 'finance', desc: 'Calculate Return on Investment percentage and profit.', isPremium: false, componentKey: 'Placeholder' },

    // 5. SEO Tools
    { id: 41, slug: 'keyword-density', name: 'Keyword Density Checker', category: 'seo', desc: 'Analyze text to find the most frequently used words.', isPremium: false, componentKey: 'Placeholder' },
    { id: 42, slug: 'meta-generator', name: 'Meta Tag Generator', category: 'seo', desc: 'Generate optimized meta tags for your HTML head.', isPremium: false, componentKey: 'Placeholder' },
    { id: 43, slug: 'seo-analyzer', name: 'SEO Analyzer', category: 'seo', desc: 'Analyze URLs for common on-page SEO issues.', isPremium: false, componentKey: 'Placeholder' },
    { id: 44, slug: 'backlink-checker', name: 'Backlink Checker', category: 'seo', desc: 'Discover referring domains pointing to your site.', isPremium: false, componentKey: 'Placeholder' },
    { id: 45, slug: 'robots-txt-generator', name: 'Robots.txt Generator', category: 'seo', desc: 'Create robots.txt files to manage search crawlers.', isPremium: false, componentKey: 'Placeholder' },
    { id: 46, slug: 'sitemap-generator', name: 'Sitemap Generator', category: 'seo', desc: 'Generate XML sitemaps for Google Search Console.', isPremium: false, componentKey: 'Placeholder' },
    { id: 47, slug: 'index-checker', name: 'Google Index Checker', category: 'seo', desc: 'Check if specific URLs are indexed in Google.', isPremium: false, componentKey: 'Placeholder' },
    { id: 48, slug: 'serp-simulator', name: 'SERP Simulator', category: 'seo', desc: 'Preview how your site appears in Google search results.', isPremium: false, componentKey: 'Placeholder' },
    { id: 49, slug: 'open-graph-checker', name: 'Open Graph Checker', category: 'seo', desc: 'Test how your links look when shared on social media.', isPremium: false, componentKey: 'Placeholder' },
    { id: 50, slug: 'canonical-generator', name: 'Canonical Tag Generator', category: 'seo', desc: 'Generate canonical tags to prevent duplicate content.', isPremium: false, componentKey: 'Placeholder' },
    ...
    { id: 52, slug: 'case-converter', name: 'Case Converter', category: 'text', desc: 'Transform text to uppercase, lowercase, camelCase, etc.', isPremium: false, componentKey: 'Placeholder' },
    { id: 53, slug: 'duplicate-remover', name: 'Duplicate Line Remover', category: 'text', desc: 'Remove duplicate lines from text lists automatically.', isPremium: false, componentKey: 'Placeholder' },
    { id: 54, slug: 'text-sorter', name: 'Text Line Sorter', category: 'text', desc: 'Alphabetize or reverse sort lists of words.', isPremium: false, componentKey: 'Placeholder' },
    { id: 55, slug: 'lorem-ipsum', name: 'Lorem Ipsum Generator', category: 'text', desc: 'Generate placeholder dummy text for mockups.', isPremium: false, componentKey: 'Placeholder' },
    { id: 56, slug: 'string-reverse', name: 'String Reverser', category: 'text', desc: 'Reverse the order of characters in any string.', isPremium: false, componentKey: 'Placeholder' },
    { id: 57, slug: 'whitespace-remover', name: 'Whitespace Remover', category: 'text', desc: 'Strip extra spaces, tabs, and newlines from text.', isPremium: false, componentKey: 'Placeholder' },
    { id: 58, slug: 'diff-checker', name: 'Diff Checker', category: 'text', desc: 'Compare two text files and highlight the differences.', isPremium: false, componentKey: 'Placeholder' },
    { id: 59, slug: 'markdown-editor', name: 'Markdown Editor', category: 'text', desc: 'Write in Markdown and preview HTML instantly.', isPremium: false, componentKey: 'Placeholder' },
    { id: 60, slug: 'text-to-binary', name: 'Text to Binary', category: 'text', desc: 'Convert ASCII text directly into binary format.', isPremium: false, componentKey: 'Placeholder' },

    // 7. Security Tools
    { id: 61, slug: 'password-generator', name: 'Password Generator', category: 'security', desc: 'Generate highly secure, randomized passwords.', isPremium: false, componentKey: 'Placeholder' },
    { id: 62, slug: 'hash-generator', name: 'Hash Generator', category: 'security', desc: 'Generate MD5, SHA-1, SHA-256 and other cryptographic hashes.', isPremium: false, componentKey: 'Placeholder' },
    { id: 63, slug: 'url-encoder', name: 'URL Encoder/Decoder', category: 'security', desc: 'Safely encode URL parameters for HTTP requests.', isPremium: false, componentKey: 'Placeholder' },
    { id: 64, slug: 'ip-lookup', name: 'IP Address Lookup', category: 'security', desc: 'Find geolocation and ISP info for any IPv4 address.', isPremium: false, componentKey: 'Placeholder' },
    { id: 65, slug: 'whois-lookup', name: 'Whois Lookup', category: 'security', desc: 'Discover registration details of domain names.', isPremium: false, componentKey: 'Placeholder' },
    { id: 66, slug: 'ssl-checker', name: 'SSL Certificate Checker', category: 'security', desc: 'Verify SSL certificate validity and expiration dates.', isPremium: false, componentKey: 'Placeholder' },
    { id: 67, slug: 'mac-lookup', name: 'MAC Address Lookup', category: 'security', desc: 'Find the manufacturer behind a MAC address OUI.', isPremium: false, componentKey: 'Placeholder' },
    { id: 68, slug: 'port-scanner', name: 'Port Scanner', category: 'security', desc: 'Scan common ports to see if they are open.', isPremium: false, componentKey: 'Placeholder' },
    { id: 69, slug: 'bcrypt-generator', name: 'Bcrypt Hash Generator', category: 'security', desc: 'Generate strong Bcrypt hashes for password storage.', isPremium: false, componentKey: 'Placeholder' },
    { id: 70, slug: 'base32-encoder', name: 'Base32 Encoder', category: 'security', desc: 'Encode data to Base32 (RFC 4648) format.', isPremium: false, componentKey: 'Placeholder' },

    // 8. Productivity Tools
    { id: 71, slug: 'pomodoro-timer', name: 'Pomodoro Timer', category: 'productivity', desc: 'Stay focused using the Pomodoro 25/5 technique.', isPremium: false, componentKey: 'Placeholder' },
    { id: 72, slug: 'todo-list', name: 'To-do List', category: 'productivity', desc: 'A simple local storage-based task manager.', isPremium: false, componentKey: 'Placeholder' },
    { id: 73, slug: 'secure-notes', name: 'Secure Notes', category: 'productivity', desc: 'Write and encrypt text notes right in your browser.', isPremium: false, componentKey: 'Placeholder' },
    { id: 74, slug: 'timezone-converter', name: 'Timezone Converter', category: 'productivity', desc: 'Compare and convert times across global cities.', isPremium: false, componentKey: 'Placeholder' },
    { id: 75, slug: 'unit-converter', name: 'Unit Converter', category: 'productivity', desc: 'Convert length, weight, temperature, and volume.', isPremium: false, componentKey: 'Placeholder' },
    { id: 76, slug: 'age-calculator', name: 'Age Calculator', category: 'productivity', desc: 'Calculate exact age in years, months, and days.', isPremium: false, componentKey: 'Placeholder' },
    { id: 77, slug: 'days-between', name: 'Days Between Dates', category: 'productivity', desc: 'Find the exact number of days between two dates.', isPremium: false, componentKey: 'Placeholder' },
    { id: 78, slug: 'stopwatch', name: 'Online Stopwatch', category: 'productivity', desc: 'A digital stopwatch with split lap times.', isPremium: false, componentKey: 'Placeholder' },
    { id: 79, slug: 'percentage-calculator', name: 'Percentage Calculator', category: 'productivity', desc: 'Easily calculate percentage increases or decreases.', isPremium: false, componentKey: 'Placeholder' },
    { id: 80, slug: 'habit-tracker', name: 'Habit Tracker', category: 'productivity', desc: 'Track daily habits and maintain your streak.', isPremium: false, componentKey: 'Placeholder' },
